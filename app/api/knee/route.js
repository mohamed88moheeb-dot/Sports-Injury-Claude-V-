 ...
 * ---------------------------------------------------------------------------
 * Single server entry for the knee engine. runKnee() is pure (no fs), but is
 * kept server-side to mirror the RF/quad routes and keep the engine off the
 * client bundle. The client (RecoveryContext) POSTs a mapped knee input and
 * gets the structured knee output back.
 * ---------------------------------------------------------------------------
 */
