...
const stage = (days) => runGlute({ ...base, resisted_abduction_pain: 'moderate', ability_to_continue: 'yes', pain_severity_label: 'moderate', days_since_injury: days }).plan.current_stage_id;
const mildPlan = runGlute({ ...base, resisted_abduction_pain: 'mild', ability_to_continue: 'yes', pain_severity_label: 'mild', days_since_injury: 2 }).plan;
