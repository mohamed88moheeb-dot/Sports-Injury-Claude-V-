...
export const RUPTURE_EXERCISES = [
  ...
  {
    id: 'TR-EX-024', name: 'Single-leg balance & landing prep', block: 'control_balance', phase: 'strength',
    purpose: 'Rebuild single-leg control and landing tolerance before running.',
    why: 'Landing/deceleration control needs to be re-established before impact-loading is reintroduced post-repair.',
    equipment: ['bodyweight'], source_refs: ['QUAD-CIT-013'], clinician_gated: true,
    dosage_by_tier: [{ sets: '—', detail: 'single-leg stance -> soft double-leg landings, clinician-paced' }],
    instructions: ['Progress single-leg balance work, then gentle double-leg landings, only as cleared.'],
    regression: 'double-leg balance only', progression: 'TR-EX-030',
    cautions: ['No landing/impact work without clinician sign-off.'],
  },
  {
    id: 'TR-EX-025', name: 'Hip and trunk support strengthening', block: 'strength_support', phase: 'strength',
    purpose: 'Support the kinetic chain around the healing knee.',
    why: 'Hip/trunk strength offloads the extensor mechanism during daily and sport tasks while quad strength catches up.',
    equipment: ['bodyweight', 'band'], source_refs: ['QUAD-CIT-013'], clinician_gated: true,
    dosage_by_tier: [{ sets: '—', detail: 'glute/hip and core work, per clinician programme' }],
    instructions: ['Add hip and trunk strength work alongside quad-focused strengthening.'],
    regression: 'reduce load', progression: 'TR-EX-022',
    cautions: [],
  },
  ...
  {
    id: 'TR-EX-032', name: 'Maintenance strength (anti-recurrence)', block: 'strength_support', phase: 'return',
    purpose: 'Keep quad strength up once cleared, to protect the repair long-term.',
    why: 'Ongoing strength work supports the repaired tendon and reduces re-injury risk after full return.',
    equipment: ['gym'], source_refs: ['QUAD-CIT-013'], clinician_gated: true,
    dosage_by_tier: [{ sets: '—', detail: '1-2 quad strength sessions/week ongoing, per clinician' }],
    instructions: ['Keep regular quad strength work in your routine once cleared for normal training.'],
    regression: 'reduce load', progression: 'periodised strength',
    cautions: [],
  },
  {
    id: 'TR-EX-033', name: 'Multidirectional / change-of-direction progression', block: 'running_sport_prep', phase: 'return',
    purpose: 'Reintroduce cutting and multidirectional demand after linear running is established.',
    why: 'Cutting loads the extensor mechanism eccentrically at speed — the last exposure before full sport clearance.',
    equipment: ['bodyweight', 'cones'], source_refs: ['QUAD-CIT-014'], clinician_gated: true,
    dosage_by_tier: [{ sets: '—', detail: 'planned wide cuts -> sharper cuts -> reactive cutting, clinician-paced' }],
    instructions: ['Progress from planned, gentle direction changes to sharper and reactive cutting only as cleared.'],
    regression: 'TR-EX-030', progression: 'TR-EX-031',
    cautions: ['Do not progress cutting sharpness without clinician sign-off.'],
  },
];
