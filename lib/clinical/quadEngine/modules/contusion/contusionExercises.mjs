...
export const CONTUSION_EXERCISES = [
  ...
  {
    id: 'CN-EX-006', name: 'Ankle pumps + gentle circulation walk', block: 'conditioning', phase: 'acute_rom',
    purpose: 'Support circulation and lymphatic drainage without loading the bruise directly.',
    why: 'Gentle distal movement and short walks reduce swelling pooling in the acute phase.',
    stretch_demand: 'low',
    equipment: ['bodyweight'], source_refs: ['QUAD-CIT-005'],
    dosage_by_tier: [{ sets: '—', detail: 'ankle pumps 2 min + short pain-free walk' }, { sets: '—', detail: 'walk 5 min, comfortable pace' }, { sets: '—', detail: 'walk 8-10 min' }],
    instructions: ['Pump the ankles up and down seated, then take a short pain-free walk.'],
    regression: 'seated ankle pumps only', progression: 'CN-EX-003',
    cautions: ['Stop the walk if limping or pain increases.'],
  },
  ...
  {
    id: 'CN-EX-025', name: 'Single-leg press / extension (strength check)', block: 'strength_support', phase: 'reload',
    purpose: 'Quantify single-leg quad strength symmetry before higher-speed loading.',
    why: 'Confirming strength symmetry (not just pain-free function) reduces re-injury risk before sport exposure.',
    stretch_demand: 'moderate',
    equipment: ['machine', 'gym'], source_refs: ['QUAD-CIT-002', 'QUAD-CIT-016'],
    dosage_by_tier: [{ sets: '3', reps: '10 each' }, { sets: '3', reps: '8 each' }, { sets: '4', reps: '8 each', load: 'building' }],
    instructions: ['Press or extend with the injured leg only, comparing effort/load to the uninjured side.'],
    regression: 'CN-EX-020', progression: 'CN-EX-030',
    cautions: [],
  },
  ...
  {
    id: 'CN-EX-033', name: 'Single-leg plyometric progression', block: 'control_balance', phase: 'return',
    purpose: 'Reactive strength and landing control at sport-level demand.',
    why: 'Restores stretch-shortening capacity once double-leg landing is comfortable.',
    stretch_demand: 'high', speed_power: 'high',
    equipment: ['bodyweight'], source_refs: ['QUAD-CIT-002'],
    dosage_by_tier: [{ sets: '3', reps: '6 single-leg' }, { sets: '3', reps: '8 reactive' }, { sets: '4', reps: '8 bounding' }],
    instructions: ['Progress hops to bounds on the injured leg, focusing on soft, controlled landings.'],
    regression: 'CN-EX-023', progression: 'depth jumps',
    cautions: ['Quad size/firmness should equal the uninjured side before progressing.'],
  },
  {
    id: 'CN-EX-034', name: 'Multidirectional agility drills', block: 'running_sport_prep', phase: 'return',
    purpose: 'Sport-specific change-of-direction exposure beyond straight-line running.',
    why: 'Cutting and multidirectional demand is where most contusion re-aggravation happens if introduced too early.',
    stretch_demand: 'high', speed_power: 'high',
    equipment: ['bodyweight', 'cones'], source_refs: ['QUAD-CIT-002'],
    dosage_by_tier: [{ sets: '—', detail: 'planned wide-angle cuts' }, { sets: '—', detail: 'sharper / faster cuts' }, { sets: '—', detail: 'reactive game-speed cutting' }],
    instructions: ['Run planned cutting patterns first, building sharpness and reaction over sessions.'],
    regression: 'CN-EX-030', progression: 'CN-EX-031',
    cautions: [],
  },
  {
    id: 'CN-EX-035', name: 'Maintenance strength + conditioning', block: 'strength_support', phase: 'return',
    purpose: 'Keep quad strength and conditioning up once cleared to train fully.',
    why: 'Ongoing strength work protects against recurrence after return to sport.',
    stretch_demand: 'moderate',
    equipment: ['gym'], source_refs: ['QUAD-CIT-002'],
    dosage_by_tier: [{ sets: '3', reps: '8' }, { sets: '3-4', reps: '6-8' }, { sets: '4', reps: '6', load: 'heavier' }],
    instructions: ['Keep 1-2 quad strength sessions per week ongoing alongside normal training.'],
