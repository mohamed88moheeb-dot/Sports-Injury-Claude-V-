...
export const SESSION_TIER_STRUCTURE = {
  ...
  foundation: [
    ...
    },
    {
      ...
      // [BFR_CONSENSUS — Hughes 2017 BJSM doi:10.1136/bjsports-2016-097071]
      // BFR preserves quadriceps hypertrophy during acute-phase healing when
      // absolute loads must stay minimal. Add to end of session when available
      // and supervised. NOT wired into the session rotation — treated as an
      // explicit supervised add-on by the clinician or physio.
      bfr_supplement: {
        exercise_id: 'RF-EX-107',
        when: 'Add to the end of this session if a BFR cuff is available and applied under supervision.',
        dosage: {
          sets:         '3–4',
          reps_or_hold: '30 reps (set 1), 15 reps (sets 2–4)',
          rest:         '30 seconds between sets',
          intensity:    '20–30% of estimated single-leg press 1RM',
          cuff:         'Apply to proximal thigh. Target ~80% arterial occlusion pressure (AOP). Verify using a Doppler or cuff pressure guide — never exceed 80% AOP.',
        },
    ...
    },
    {
      ...
      bfr_supplement: {
        ...
        dosage: {
          ...
          rest:         '30 seconds between sets',
          intensity:    '20–30% of estimated single-leg press 1RM',
          cuff:         'Apply to proximal thigh. Target ~80% arterial occlusion pressure. Verify with a Doppler or cuff pressure guide.',
        },
        requires_supervision: true,
      },
    },
  ...
  reload: [
    {
      ...
      // [BFR_CONSENSUS — Hughes 2017 BJSM doi:10.1136/bjsports-2016-097071]
      // In Reload, BFR can be applied with early isotonic exercises (knee extension,
      // short-arc quad) at low absolute load to accelerate hypertrophy stimulus.
      bfr_supplement: {
        exercise_id: 'RF-EX-107',
        when: 'Add after tissue-specific loading block if BFR cuff is available and supervised.',
        dosage: {
          sets:         '4',
          reps_or_hold: '30 reps (set 1), 15 reps (sets 2–4)',
          rest:         '30 seconds between sets',
          intensity:    '20–30% of estimated 1RM on the chosen exercise (e.g. leg extension or short-arc quad)',
          cuff:         'Proximal thigh. ~80% AOP. Remove immediately if pain, numbness, or unusual discomfort occurs.',
        },
        requires_supervision: true,
      },
    },
  ...
  accumulation: [
    ...
    },
    {
      ...
      // LSI checkpoint before advancing to Transition.
      // Sources: Buckthorpe 2019 BJSM (PMC6579500); Hickey 2022 JSAMS (PMID:35794049).
      lsi_checkpoint: {
        test:      'Single-leg squat comparison — how does the injured leg compare to the uninjured leg? (self-report 0–100%)',
        threshold: 70,
        purpose:   'LSI ≥70% on single-leg squat is required before advancing to Transition phase. Below 70%: continue Accumulation and prioritize unilateral quad and glute loading.',
        note:      'Self-reported LSI is a screening tool. Objective isokinetic assessment (RF-EX-084) or clinician-administered strength testing provides the most valid LSI measurement.',
      },
    },
  ],
  ...
  simulation: [
    {
      ...
      // Kicking progression gate: applies to Pattern A (proximal/kicking) patients.
      // For non-kicking athletes, this gate can be skipped — sprint drills remain the RTS focus.
      // Effort percentages and volume are clinical estimates; adapt to individual response.
      kicking_gate: {
        applies_to_pattern: 'A',
        entry_criteria: [
          'Jogging at 80%+ effort for ≥3 consecutive sessions without pain exceeding 1/10.',
          'Single-leg squat LSI ≥85% (self-reported or objective).',
          'Full isometric quad and hip-flexor contraction pain-free.',
          'Hip-flexor range equal to uninjured side.',
        ],
        progression: [
          { step: 1, exercise_id: 'RF-EX-065', effort_pct: '50–60', volume: '10 swings × 2 sets',     note: 'Pattern only — no ball, no contact. Hip swing through full arc.' },
          { step: 2, exercise_id: 'RF-EX-066', effort_pct: '60–70', volume: '8–10 kicks × 2 sets',    note: 'Stationary ball, supported on wall/post. Focus on backswing and follow-through.' },
          { step: 3, exercise_id: 'RF-EX-067', effort_pct: '70–80', volume: '10 kicks × 2–3 sets',    note: 'Unsupported. Natural approach. Monitor anterior thigh response.' },
          { step: 4, exercise_id: 'RF-EX-068', effort_pct: '75–85', volume: '8 kicks × 2–3 sets',     note: 'Resisted kicking against light band. Technique must be maintained.' },
          { step: 5, exercise_id: 'RF-EX-069', effort_pct: '85–95', volume: 'Match volume per session', note: 'Full ball-work integration: passes, crosses, shooting. Progress over multiple sessions.' },
        ],
        progression_rule: 'Advance one step per session when: (a) pain remains ≤2/10 during, and (b) next-day response is same or better. If pain exceeds 2/10 during any step, regress to the previous step.',
        exit_criteria: [
          'Full-effort kick (step 5) with ≥10 repetitions pain-free (≤2/10).',
          '24-hour next-day response: no worse than sore-but-settled.',
          'No detectable asymmetry in kick mechanics vs. pre-injury.',
        ],
      },
    },
    {
