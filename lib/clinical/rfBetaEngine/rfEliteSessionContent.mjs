 ...
 *
 * Session volume model (Aspetar 6-phase):
 *   Foundation early→late:    6 → 9 → 11 exercises
 *   Reload early→late:        9 → 12 → 12 exercises
 *   Accumulation early→late: 11 → 14 → 15 exercises
 *   Transition early→late:   11 → 10 → 11 exercises
 *   Simulation early→late:    9 → 10 → 10 exercises
 *   Resilience early→late:    7 →  8 →  8 exercises
 *
...
export const EXERCISE_CONTENT = {
  ...
  'RF-EX-103': {
    purpose: 'High-demand eccentric quad loading in the lengthened position — a gold-standard exercise for RF rehabilitation.',
    instructions: [
  ...
  'RF-EX-013': {
    purpose: 'Advanced eccentric quad loading — highest eccentric RF exercise in the program; evidence-based for quad injury prevention.',
    instructions: [
...
export const SESSION_TIER_STRUCTURE = {
  ...
  foundation: [
    {
      tier: 'early',
      session_title: 'Foundation — Session 1',
      description: 'Gentle re-introduction. Activation + basic mobility + one proximal support exercise.',
      blocks: [
        { block: 'conditioning',            count: 1, dosage: { sets: '1',   reps_or_hold: '10–15 min at easy pace',      rest: 'n/a',  intensity: 'easy — RPE 2',          tempo: 'smooth and comfortable' } },
        ...
        { block: 'tissue_specific_loading', count: 2, dosage: { sets: '2',   reps_or_hold: '5 holds of 5 seconds',         rest: '45s',  intensity: 'very light — RPE 2–3',   tempo: 'controlled hold'        } },
        { block: 'strength_support',        count: 1, dosage: { sets: '2',   reps_or_hold: '8–10 reps',                    rest: '60s',  intensity: 'light — RPE 3',          tempo: 'controlled'             } },
      ]
    },
    {
      tier: 'mid',
      session_title: 'Foundation — Session 2',
      description: 'Building volume. More activation variety + first core/control work.',
      blocks: [
        { block: 'conditioning',            count: 1, dosage: { sets: '1',   reps_or_hold: '12–15 min at easy pace',       rest: 'n/a',  intensity: 'easy — RPE 2',          tempo: 'comfortable'  } },
        { block: 'mobility_activation',     count: 2, dosage: { sets: '2',   reps_or_hold: '10 controlled reps',           rest: 'short', intensity: 'pain-free range',        tempo: 'slow'         } },
        { block: 'tissue_specific_loading', count: 3, dosage: { sets: '2–3', reps_or_hold: '8 holds of 5 seconds',         rest: '45s',  intensity: 'light — RPE 3–4',        tempo: 'controlled'   } },
        { block: 'strength_support',        count: 2, dosage: { sets: '2–3', reps_or_hold: '10 reps',                      rest: '60s',  intensity: 'light — RPE 3',          tempo: 'controlled'   } },
        { block: 'control_balance',         count: 1, dosage: { sets: '2',   reps_or_hold: '20–30s holds',                 rest: '60s',  intensity: 'light',                  tempo: 'steady hold'  } },
      ]
    },
    {
      tier: 'late',
      session_title: 'Foundation — Session 3',
      description: 'Foundation peak. Full block coverage, more strength and core. Approaching Reload readiness.',
      blocks: [
        { block: 'conditioning',            count: 1, dosage: { sets: '1',   reps_or_hold: '15 min at easy–moderate pace', rest: 'n/a',  intensity: 'easy–moderate — RPE 3',  tempo: 'comfortable'   } },
        ...
        { block: 'tissue_specific_loading', count: 3, dosage: { sets: '3',   reps_or_hold: '8–10 holds of 5–7 seconds',    rest: '45s',  intensity: 'light–moderate — RPE 4', tempo: 'controlled'    } },
        { block: 'strength_support',        count: 3, dosage: { sets: '3',   reps_or_hold: '10–12 reps',                   rest: '60s',  intensity: 'light–moderate — RPE 4', tempo: 'controlled'    } },
        { block: 'control_balance',         count: 2, dosage: { sets: '2–3', reps_or_hold: '25–30s holds or 10 reps',      rest: '60s',  intensity: 'light–moderate',         tempo: 'steady'        } },
      ]
    },
  ],
