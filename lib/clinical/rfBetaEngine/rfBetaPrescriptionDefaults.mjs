...
export const MAX_ACTIVE_CARDS_PER_PHASE = {
  foundation: 11, reload: 12, accumulation: 15, transition: 11, simulation: 10, resilience: 8
};
...
const DOSAGE = {
  foundation: {
    isometric: { sets: '3', reps_or_hold: '5 reps × 3–5s hold', rest: 'as needed', intensity: 'very light', tempo: 'slow and controlled', frequency: 'most days' },
    ...
    tissue_specific_loading: { sets: '3', reps_or_hold: '5 reps × 3–5s hold', rest: '45s', intensity: 'very light', tempo: 'controlled hold', frequency: 'most days' },
