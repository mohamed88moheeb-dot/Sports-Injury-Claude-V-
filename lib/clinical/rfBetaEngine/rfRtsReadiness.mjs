...
export function resolveRtsReadiness(input = {}) {
  ...
  return {
    ...
    clearance_note: 'This is a readiness guide, not clearance. Return-to-sport must be confirmed by a qualified clinician — objective strength and hop-symmetry testing (≥90% limb symmetry) are recommended before full return.',
