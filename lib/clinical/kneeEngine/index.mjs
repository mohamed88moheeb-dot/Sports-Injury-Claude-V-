    ...
    stages: stages.map((stage, idx) => {
      ...
      return {
        ...
        sessions: [{
          ...
          // Bookend every session with a stage-appropriate RAMP warm-up (first)
          // and a cooldown + recovery card (last), so each session is complete.
          cards: [
            kneeWarmupCard(stage.id),
            ...pool.map((e) => ({
