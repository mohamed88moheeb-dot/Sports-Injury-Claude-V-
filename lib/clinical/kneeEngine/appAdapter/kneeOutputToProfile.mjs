...
export function kneeOutputToProfile(kneeOutput, appAssessment = {}) {
  ...
  const rf = {
    ...
    recovery: { wording: 'Estimated window for this pattern — actual recovery depends on grade, symptoms, sport demands, and clinician review.', beta_display: recoveryLabel, modifiers: [] },
