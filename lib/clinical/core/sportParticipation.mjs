 ...
 */
export function deriveSportParticipation({ kind = null, grade = null, irritability = null, band = null, reviewRequired = false, planTotalWeeks = null, finalStageWeeks = null } = {}) {
  if (reviewRequired) {
    return {
      level: 'medical_first',
